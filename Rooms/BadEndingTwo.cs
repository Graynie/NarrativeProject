...
namespace NarrativeProject.Rooms
{
    internal class BadEndingTwo : Room
    {
        ...
        {
            return @"   Ending(2/3): You got Caugth
Your husband has been killed and you haven't been caught.

As the police arrive and enter the living room, their expressions shift from curiosity to grim realization. Their eyes narrow as they take in the scene—the lifeless body of your husband.
